//------------------------------------------------------------------------------
// <copyright file="FStarVSPackage.cs" company="Company">
...
namespace VisualFStar
{
    ...
    public sealed class FStarVSPackage : Package, IOleComponent
    {
        /// <summary>
        /// FStarVSPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "a708357b-a19e-43ad-b717-40e0cf6b1091";

        /// <summary>
        /// Initializes a new instance of the <see cref="FStarVSPackage"/> class.
        /// </summary>
        public FStarVSPackage()
        {
