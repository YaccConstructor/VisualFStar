...
namespace FStarProject
{
   ...
   // [Guid(FStarProjectPackage.PackageGuidString)]
    ...
    [ProvideProjectFactory(typeof(FStarProject.Templates.Projects.FSharpProject.FSharpProjectFactory), null,
    ...
    public sealed class FSharpProjectPackage : ProjectPackage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FSharpProjectPackage"/> class.
        /// </summary>
        public FSharpProjectPackage()
        {
        ...
        {
            base.Initialize();
            this.RegisterProjectFactory(new FStarProject.Templates.Projects.FSharpProject.FSharpProjectFactory(this));
        }
